      ...
      <div className="whole_services">
        {isVisible('app-development') && (
          <div id="app-development" className="container_services">
            ...
            <img src={`${process.env.PUBLIC_URL}/Key/app_dev.jpg`} alt="none" style={{ width: '30rem', marginLeft: '10vw', marginBottom: '2vh', marginTop: '2vh', height: '300px' }} />
        ...
        {isVisible('cloud-services') && (
          <div id="cloud-services" className="container_services">
            ...
            <img src={`${process.env.PUBLIC_URL}/Key/Cloud.jpg`} alt="none" style={{ width: '35rem', marginLeft: '6vw', marginBottom: '2vh', marginTop: '2vh', height: '220px' }} />
        ...
        {isVisible('consulting-services') && (
          <div id="consulting-services" className="container_services">
            ...
            <img src={`${process.env.PUBLIC_URL}/Key/consulting.jpg`} alt="none" style={{ width: '30rem', marginLeft: '10vw', marginBottom: '2vh', marginTop: '2vh', height: '350px' }} />
        ...
        {isVisible('startup-services') && (
          <div id="startup-services" className="container_services">
            ...
            <img src={`${process.env.PUBLIC_URL}/Key/StartUp.jpg`} alt="none" style={{ width: '30rem', marginLeft: '9vw', marginBottom: '2vh', marginTop: '2vh' }} />
        ...
        {isVisible('web-development') && (
          <div id="web-development" className="container_services">
            ...
            <img src={`${process.env.PUBLIC_URL}/Key/Web_dev.jpg`} alt="none" style={{ width: '30rem', marginLeft: '9vw', marginBottom: '2vh', marginTop: '2vh' }} />
        ...
        {isVisible('internships') && (
          <div id="internships" className="container_services">
            <h1>Internships</h1>
            <img src={`${process.env.PUBLIC_URL}/Key/Internships.jpg`} alt="none" style={{ width: '30rem', marginLeft: '9vw', marginBottom: '2vh', marginTop: '2vh' }} />
        ...
        {isVisible('gen-ai') && (
          <div id="gen-ai" className="container_services">
            <h1>Gen AI</h1>
            <img src={`${process.env.PUBLIC_URL}/Key/Gen_Ai.jpg`} alt="none" style={{ width: '40rem', marginLeft: '4vw', marginBottom: '2vh', marginTop: '2vh' }} />
        ...
        {isVisible('aiml') && (
          <div id="aiml" className="container_services">
            ...
            <img src={`${process.env.PUBLIC_URL}/Key/AIML.png`} alt="none" style={{ width: '40rem', marginLeft: '4vw', marginBottom: '2vh', marginTop: '2vh' }} />
        ...
        {isVisible('maintain') && (
          <div id="maintain" className="container_services">
            ...
            <img src={`${process.env.PUBLIC_URL}/Key/App_maintain.jpg`} alt="none" style={{ width: '30rem', marginLeft: '9vw', marginBottom: '2vh', marginTop: '2vh' }} />
        ...
        {isVisible('issue-res') && (
          <div id="issue-res" className="container_services">
            ...
            <img src={`${process.env.PUBLIC_URL}/Key/Issue_res.jpg`} alt="none" style={{ width: '30rem', marginLeft: '9vw', marginBottom: '2vh', marginTop: '2vh' }} />
